...
answer1 = data.map(el => ({id: el.id,username: el.username}));
console.log(answer1);


answer2 = data.reduce((acc,curr) => {
  return [...acc,curr.email]
},[])
console.log(answer2);


answer3 = data.find(el => el.id === 9)
console.log(answer3);


answer4 = data.filter(el=> el.address.city === 'Lebsackbury');
console.log(answer4);


answer5 = data.slice(0,5);
console.log(answer5);
